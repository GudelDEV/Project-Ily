    ...
    <div class="wrapper">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        ...
                        <a href="#" class="dropdown-item">
                            <!-- Message Start -->
                            <div class="media">
                                <img src="dist/img/20190222_191005.jpg" alt="User Avatar"
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="adminLTE.html" class="brand-link">
                <img src="dist/img/logo.png" alt=" Logo delman" class="brand-image img-circle elevation-3"
                    style="opacity: .8">
                        ...
                        <div class="col-lg-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="card-text">
                                        Wili Mar'ah <br> 221223023 <br> PTIK 4A
                                    </p>
